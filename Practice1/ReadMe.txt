...
The parameters and returns are given for each function. You will be editing the classroom.js file and writing the necessary functions to perform the tasks above.
...
To run your code from terminal, you may use:    node <scriptname>.js
    - To run your code, use:    node classroom.js
